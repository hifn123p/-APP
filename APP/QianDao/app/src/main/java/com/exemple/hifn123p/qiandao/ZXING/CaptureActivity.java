package com.exemple.hifn123p.qiandao.ZXING;
...
import com.exemple.hifn123p.qiandao.ZXING.camera.CameraManager;
import com.exemple.hifn123p.qiandao.ZXING.widgets.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		...
		if (handler == null) {
			handler = new com.exemple.hifn123p.qiandao.ZXING.CaptureActivityHandler(this, decodeFormats,
	...
	public void handleDecode(final Result rawResult, Bitmap barcode,
		...
		Toast.makeText(CaptureActivity.this, rawResult.toString(),Toast.LENGTH_SHORT).show();
		finish();
//		dialog.setTitle("扫描结果是");
