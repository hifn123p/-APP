...
package com.exemple.hifn123p.qiandao.ZXING.camera;
...
public final class CameraConfigurationUtils {
	...
	public static void setFocus(Camera.Parameters parameters,
		...
		if (autoFocus) {
			if (safeMode || disableContinuous) {
				focusMode = CameraConfigurationUtils.findSettableValue(
						"focus mode", supportedFocusModes,
	...
	public static void setTorch(Camera.Parameters parameters, boolean on) {
		...
		String flashMode;
		if (on) {
			flashMode = CameraConfigurationUtils.findSettableValue(
					"flash mode", supportedFlashModes,
	...
	public static void setInvertColor(Camera.Parameters parameters) {
		...
		String colorMode = CameraConfigurationUtils.findSettableValue(
				"color effect", parameters.getSupportedColorEffects(),
